      ...
      <Show when={isOpen()}>
        ...
        <div class="absolute top-full mt-2 right-0 w-64 bg-neutral-800 border border-neutral-700 rounded-lg shadow-xl z-50 overflow-hidden">
            ...
            <For each={organizations()}>
              {(org) => (
                <button
                  ...
                  class={`w-full text-left px-3 py-2 hover:bg-neutral-700 transition-colors flex items-center justify-between ${
                    currentOrg()?.id === org.id ? "bg-neutral-700" : ""
                  }`}
                >
          ...
          <Show when={organizations().length === 0}>
            <div class="px-3 py-8 text-center text-neutral-400 text-sm">
